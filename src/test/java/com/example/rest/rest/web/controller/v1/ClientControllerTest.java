...
//        String expectedResponse = StringTestUtils.readStringFromResource("/response/find_all_clients_response.json");
        ...
        ClassPathResource resource = new ClassPathResource("response/find_all_clients_response.json");
        byte[] data = FileCopyUtils.copyToByteArray(resource.getInputStream());
        String expectedResponse = new String(data, StandardCharsets.UTF_8);
    ...
    @Test
    public void whenDetClientById_thenReturnClientById() throws Exception {
        ...
        ClassPathResource resource = new ClassPathResource("response/find_client_by_id_response.json");
        byte[] data = FileCopyUtils.copyToByteArray(resource.getInputStream());
        String expectedResponse = new String(data, StandardCharsets.UTF_8);
    ...
    public void whenCreateClient_thenReturnNewClient() throws Exception{
        ...
        ClassPathResource resource = new ClassPathResource("response/create_client_response.json");
        byte[] data = FileCopyUtils.copyToByteArray(resource.getInputStream());
        String expectedResponse = new String(data, StandardCharsets.UTF_8);
    ...
    public void whenUpdateClient_thenReturnUpdatedClient() throws Exception {
        ...
        ClassPathResource resource = new ClassPathResource("response/update_client_response.json");
        byte[] data = FileCopyUtils.copyToByteArray(resource.getInputStream());
        String expectedResponse = new String(data, StandardCharsets.UTF_8);
    ...
    @Test
    public void whenDeleteClientBtId_thenReturnStatusNoContent() throws Exception{
    ...
    @Test
    public void whenFindByIdNoExistedClient_thenReturnError() throws Exception{
        ...
        ClassPathResource resource = new ClassPathResource("response/clietn_by_by_id_not_found_response.json");
        byte[] data = FileCopyUtils.copyToByteArray(resource.getInputStream());
        String expectedResponse = new String(data, StandardCharsets.UTF_8);
    ...
    public void whenCreateClientWithEmptyName_thenReturnError() throws Exception{
        ...
        String actualResponse = response.getContentAsString();
        ClassPathResource resource = new ClassPathResource("response/empty_client_name_response.json");
        byte[] data = FileCopyUtils.copyToByteArray(resource.getInputStream());
        String expectedResponse = new String(data, StandardCharsets.UTF_8);
    ...
    public void whenCreateClientWithInvalidSizeName_thenReturnError(String name) throws Exception{
        ...
        String actualResponse = response.getContentAsString();
        ClassPathResource resource = new ClassPathResource("response/client_name_size_exception_response.json");
        byte[] data = FileCopyUtils.copyToByteArray(resource.getInputStream());
        String expectedResponse = new String(data, StandardCharsets.UTF_8);
